...
namespace WindowsFormsApp1 {
    ...
    public partial class LibraryDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerRow AddCustomerRow(string Code, string Name, string Gender, string Phone, string Address, string Type) {
...
namespace WindowsFormsApp1.LibraryDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customer] WHERE (([Code] = @Original_Code) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([Code], [Name], [Gender], [Phone], [Address], [Type" +
                "]) VALUES (@Code, @Name, @Gender, @Phone, @Address, @Type);\r\nSELECT Code, Name, " +
                "Gender, Phone, Address, Type FROM Customer WHERE (Code = @Code)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [Code] = @Code, [Name] = @Name, [Gender] = @Gender, [Phone] = @Phone, [Address] = @Address, [Type] = @Type WHERE (([Code] = @Original_Code) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)));
SELECT Code, Name, Gender, Phone, Address, Type FROM Customer WHERE (Code = @Code)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Code, Name, Gender, Phone, Address, Type FROM dbo.Customer";
        ...
        public virtual int Delete(string Original_Code, string Original_Name, string Original_Gender, string Original_Phone, string Original_Address, string Original_Type) {
        ...
        public virtual int Insert(string Code, string Name, string Gender, string Phone, string Address, string Type) {
            if ((Code == null)) {
        ...
        public virtual int Update(string Code, string Name, string Gender, string Phone, string Address, string Type, string Original_Code, string Original_Name, string Original_Gender, string Original_Phone, string Original_Address, string Original_Type) {
            if ((Code == null)) {
                throw new global::System.ArgumentNullException("Code");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Gender, string Phone, string Address, string Type, string Original_Code, string Original_Name, string Original_Gender, string Original_Phone, string Original_Address, string Original_Type) {
            return this.Update(Original_Code, Name, Gender, Phone, Address, Type, Original_Code, Original_Name, Original_Gender, Original_Phone, Original_Address, Original_Type);
        }
    }
